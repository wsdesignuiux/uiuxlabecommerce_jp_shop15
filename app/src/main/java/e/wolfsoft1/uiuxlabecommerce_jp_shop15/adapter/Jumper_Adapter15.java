...
public class Jumper_Adapter15 extends RecyclerView.Adapter<Jumper_Adapter15.MyjumperHolder> {

    private final Context context;
    private final ArrayList<Model_Shop15> jumperArrayList;

    public Jumper_Adapter15(Context context, ArrayList<Model_Shop15> jumperArrayList) {
    ...
    public MyjumperHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View v = inflater.inflate(R.layout.item_jumper15, viewGroup, false);
