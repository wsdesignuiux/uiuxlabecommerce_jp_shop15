package e.wolfsoft1.uiuxlabecommerce_jp_shop15.fragment;
...
import e.wolfsoft1.uiuxlabecommerce_jp_shop15.R;
import e.wolfsoft1.uiuxlabecommerce_jp_shop15.adapter.Jumper_Adapter15;
import e.wolfsoft1.uiuxlabecommerce_jp_shop15.model.Model_Shop15;

public class Fragment_Jumper15 extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Jumper_Adapter15 jumper_adapter15 =new Jumper_Adapter15(getActivity(),jumperArrayList);
        recyclerview_jumper.setLayoutManager(new LinearLayoutManager(getActivity()));
        recyclerview_jumper.setAdapter(jumper_adapter15);
        return view;
    }
}
